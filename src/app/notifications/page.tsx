"use client";
import { getNotifications, maskNotificationsAsRead } from '@/actions/notification.action';
import { NotificationsSkeleton } from '@/components/NotificationSkeleton';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { ScrollArea } from '@/components/ui/scroll-area';
import { Avatar, AvatarImage } from '@radix-ui/react-avatar';
import { formatDistanceToNow } from 'date-fns';
import { HeartIcon, MessageCircle, UserPlus2Icon, UserPlusIcon } from 'lucide-react';
    ...
    useEffect(() => {
        const fetchNotifications = async () => {
            ...
            try {
                ...
                if(unreadIds.length > 0) await maskNotificationsAsRead(unreadIds);
